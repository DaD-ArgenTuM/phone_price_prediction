import pandas as pd
import numpy as np         #array etc keliye
import matplotlib.pyplot as plt		#data vialisation mei help karega
import seaborn as sns
import warnings
from sklearn.model_selection import train_test_split		 
from sklearn.preprocessing import StandardScaler, LabelEncoder, OneHotEncoder		#one hot encoder
from sklearn.ensemble import RandomForestClassifier
from sklearn.metrics import accuracy_score, classification_report, confusion_matrix
import pickle		#connectivity between things 
import warnings		#to remove unneccesary warnings
